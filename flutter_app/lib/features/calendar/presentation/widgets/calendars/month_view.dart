  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return SfCalendar(
      ...
      monthCellBuilder: (context, details) {
        ...
        final bool isCurrentMonth = details.date.month == calendarController.displayDate?.month;
        
        // Filter tasks for this specific day to show indicators
        ...
        return Container(
          ...
          child: Column(
            children: [
              ...
              const Spacer(),
              // SMALL INDICATION: Dots for tasks
