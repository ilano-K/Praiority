...
// IMPORTANT: Import Task Sheet to enable switching back
  ...
  Widget _buildTypeButton(String label, ColorScheme colors) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          // 1. Fill Color: Primary (Purple) if selected, Transparent if not
          color: isSelected ? colors.primary : Colors.transparent,
          
          // 2. Border Color: Always Primary (Purple) if Selected, OR Text Color (Black) if unselected
          // WAIT - You requested "border with onSurface color remain" UNLESS toggled.
          // BUT in the last prompt you said "when task is clicked it should have the primary color AND the border with onSurface color remain"
          // Let's stick to your specific visual request:
          border: Border.all(
        ...
        child: Text(
          ...
          style: TextStyle(
            ...
            color: colors.onSurface, // Text is always OnSurface (Black)
            fontSize: 14,
          ),
        ),
      ),
